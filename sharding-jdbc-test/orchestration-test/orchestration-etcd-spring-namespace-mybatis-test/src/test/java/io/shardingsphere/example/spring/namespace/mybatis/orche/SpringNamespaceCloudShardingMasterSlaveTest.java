...
@ContextConfiguration("/META-INF/etcd/cloud/application-sharding-master-slave.xml")
public class SpringNamespaceCloudShardingMasterSlaveTest extends SpringNamespaceBaseTest {
