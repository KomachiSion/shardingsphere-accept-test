...
@ContextConfiguration("/META-INF/etcd/local/application-sharding-tables.xml")
public class SpringNamespaceLocalShardingTablesTest extends SpringNamespaceBaseTest {
