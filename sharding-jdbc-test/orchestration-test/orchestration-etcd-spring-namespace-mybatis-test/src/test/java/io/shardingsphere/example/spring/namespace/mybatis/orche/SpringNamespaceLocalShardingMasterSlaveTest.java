...
@ContextConfiguration("/META-INF/etcd/local/application-sharding-master-slave.xml")
public class SpringNamespaceLocalShardingMasterSlaveTest extends SpringNamespaceBaseTest {
