...
@ContextConfiguration("/META-INF/etcd/cloud/application-sharding-databases.xml")
public class SpringNamespaceCloudShardingDatabasesTest extends SpringNamespaceBaseTest {
