...
@ContextConfiguration("/META-INF/etcd/cloud/application-sharding-databases-tables.xml")
public class SpringNamespaceCloudShardingDatabasesTablesTest extends SpringNamespaceBaseTest {
