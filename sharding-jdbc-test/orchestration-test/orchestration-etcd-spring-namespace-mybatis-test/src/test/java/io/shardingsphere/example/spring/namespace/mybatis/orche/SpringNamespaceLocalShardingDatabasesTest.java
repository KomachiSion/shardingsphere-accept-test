...
@ContextConfiguration("/META-INF/etcd/local/application-sharding-databases.xml")
public class SpringNamespaceLocalShardingDatabasesTest extends SpringNamespaceBaseTest {
