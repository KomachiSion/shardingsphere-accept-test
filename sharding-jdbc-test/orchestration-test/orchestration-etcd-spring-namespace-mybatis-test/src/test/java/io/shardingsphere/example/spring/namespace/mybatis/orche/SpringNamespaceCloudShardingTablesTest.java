...
@ContextConfiguration("/META-INF/etcd/cloud/application-sharding-tables.xml")
public class SpringNamespaceCloudShardingTablesTest extends SpringNamespaceBaseTest {
