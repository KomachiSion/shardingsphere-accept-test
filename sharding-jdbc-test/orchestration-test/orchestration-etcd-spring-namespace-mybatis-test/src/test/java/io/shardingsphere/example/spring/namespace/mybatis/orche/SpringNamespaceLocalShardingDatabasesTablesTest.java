...
@ContextConfiguration("/META-INF/etcd/local/application-sharding-databases-tables.xml")
public class SpringNamespaceLocalShardingDatabasesTablesTest extends SpringNamespaceBaseTest {
